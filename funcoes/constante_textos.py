...
SAIDA_TOTAL_RECEITAS = 'O seu total de receitas é R$ {}'
SAIDA_TOTAL_DESPESAS = 'O seu total de despesas é R$ {}'
SAIDA_TOTAL_INVESTIMENTOS = 'A soma dos valores investidos ao longo de {} dias é: R$ {}'
SAIDA_TOTAL_VALORES_FUTUROS = 'A soma dos valores futuros ao longo de {} dias é: R$ {}'
SAIDA_SUCESSO_CRIA_RECEITAS = 'A receita de R$ {} foi adicionado com sucesso!\n'
SAIDA_SUCESSO_CRIA_DESPESAS = 'A despesa de R$ {} foi adicionado com sucesso!\n'
SAIDA_SUCESSO_CRIA_INVESTIMENTOS = 'O investimento de R$ {} sob taxa de {}% foi adicionado com sucesso!\n'
SAIDA_SUCESSO_HISTORICO = "ID: {}, Data: {}, Tipo: {}, Valor: {}"
